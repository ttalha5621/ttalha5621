...
&nbsp;
[![LinkedIn](https://img.shields.io/badge/Connect%20on%20LinkedIn-0A66C2?style=for-the-badge&logo=linkedin&logoColor=white)](https://www.linkedin.com/in/ttalha5621)
&nbsp;
[![Profile Views](https://komarev.com/ghpvc/?username=ttalha5621&style=for-the-badge&color=7C3AED&label=Profile+Views)](https://github.com/ttalha5621)
...
- 🏗️ &nbsp;I architect **business-critical applications**, ERP modules, and spatial web experiences
- 🎨 &nbsp;I translate complex requirements into **maintainable, high-performance code** with thoughtful UI
- 🌍 &nbsp;I build **GIS-powered dashboards** with Mapbox GL JS, Leaflet, and spatial data layers
- ⚡ &nbsp;I balance **usability, reliability, and speed** — always shipping products that matter
...
<table width="100%">
  <tr>
    <td width="50%" valign="top">
      ...
      <p>End-to-end enterprise platforms that streamline workflows, automate operations, and scale with business growth. Custom dashboards, reporting engines, and module-based architecture.</p>
    </td>
    <td width="50%" valign="top">
      <h3>⚛️ React Applications</h3>
      <p>Polished, performant React apps with scalable state management via Redux Toolkit or Context API. Pixel-perfect UX backed by clean, maintainable component architecture.</p>
    </td>
  </tr>
  <tr>
    <td width="50%" valign="top">
      <h3>🗺️ GIS & Mapping Solutions</h3>
      <p>Interactive geospatial web apps with Mapbox GL JS and Leaflet. Routing, geocoding, spatial queries, and location intelligence dashboards — bringing data to life on maps.</p>
    </td>
    <td width="50%" valign="top">
      <h3>🔌 APIs & Integrations</h3>
      <p>Robust RESTful and GraphQL APIs connecting frontend, backend, and third-party services. Microservices architecture, authentication flows, and real-time data pipelines.</p>
    </td>
  </tr>
</table>
...
<img src="https://capsule-render.vercel.app/api?type=waving&color=0:24243e,50:302b63,100:0f0c29&height=120&section=footer&text=Building+polished+digital+experiences+%F0%9F%9A%80&fontSize=16&fontColor=aaaaaa&fontAlignY=65&animation=fadeIn" width="100%" alt="Footer"/>

<sub>© 2026 Talha Rizwan &nbsp;|&nbsp; Crafted with ❤️ and clean code</sub>
